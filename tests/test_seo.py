...
def test_construye_indice_sitemap_de_generos_y_de_peliculas(tmp_path):
    ...
    assert manifiesto["site_url"] == "https://cinera.app"
    ...
    assert "https://cinera.app/genero/horror" in generos
    assert "https://cinera.app/top" in generos
...
def test_escapa_lo_que_hay_que_escapar(tmp_path):
    ...
    seo.construir(tmp_path, "https://cinera.app", [peligrosa], [])
...
def test_no_reescribe_un_sitemap_identico(tmp_path):
    ...
    seo.construir(tmp_path, "https://cinera.app", *datos)
